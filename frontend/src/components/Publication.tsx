export const Publication = () => {
  return (
    <>
      ...
      <div
        className=" flex flex-wrap  justify-between w-full me-10"
        id="publication"
      >
        <div className=" p-5 w-full  md:w-1/2 ">
          <div className="w-full md:w-11/12  ">
            <div className="flex flex-col items-center md:items-start md:w-3/4 w-full mx-auto">
              <h1 className=" text-4xl font-bold">प्रकाशन</h1>
              <div className="p-5 mt-7  border-4 bg-white  rounded-lg w-fit md:min-w-[300px] flex gap-3 items-center">
              ...
              <div className="p-5 mt-5 bg-white border-4 rounded-lg w-fit md:min-w-[300px] flex gap-3 items-center">
                <div className="p-5 bg-[#245fb9] font-bold text-center border rounded-full w-fit text-white">
                  आश्विन <br></br>१०
                </div>
                <div className="flex flex-col gap-1">
        ...
        <div className="w-full h-auto md:w-1/2 pe-5">
          <iframe
