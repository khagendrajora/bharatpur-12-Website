  ...
  return (
    <>
      <div className="w-full">
        ...
        <div className="flex flex-col w-full  flex-wrap justify-center p-16 mx-auto lg:w-3/4 ">
        ...
        <div className="flex w-full text-xs text-center sm:text-lg  justify-center flex-wrap mx-auto mt-10 lg:w-4/5">
        ...
        <div className="mx-auto text-center flex flex-col gap-20 mt-20 lg:w-4/5">
