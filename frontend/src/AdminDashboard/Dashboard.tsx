          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start rtl:justify-end">
              ...
              <div
                ...
                onClick={() => navigate("/")}
              >
                <img src="/logo1.jpeg" alt="logo" className="w-[70px] h-auto" />
                <h1 className="text-xs flex justifu-center flex-col gap-3">
                  <img src="/logoname.png" className="w-[150px]  sm:h-[65x] " />
                </h1>
              </div>
            </div>
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">प्रकाशन</span>
              </Link>
            </li>
            <li>
              <Link
